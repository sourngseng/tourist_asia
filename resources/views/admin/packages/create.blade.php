...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>{{ trans('global.create') }} {{ trans('menu.packages') }}</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
          <li class="breadcrumb-item active">{{ trans('global.create') }} {{ trans('menu.packages') }}</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
    ...
    <div class="col-md-8">
      <div class="card card-primary card-outline">
        <div class="card-header">
          <h4 class="float-left">{{ trans('global.create') }} {{ trans('menu.packages') }}</h4>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input name="guest" class="form-control form-control-lg" type="number" min="1"
                placeholder="Guest Number, e.g 2">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input name="price" class="form-control form-control-lg" type="number" min="1"
