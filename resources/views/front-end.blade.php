...
<head>
	...
	<!-- Js -->
	<script src="{{asset('restaurant')}}/js/vendor/modernizr-2.6.2.min.js"></script>
	<!-- <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script> -->
	<script>
		window.jQuery || document.write('<script src="{{asset('restaurant')}}/js/vendor/jquery-1.10.2.min.js"><\/script>')
	</script>
	<script src="{{asset('restaurant')}}/js/jquery.nav.js"></script>
	...
	<script src="{{asset('restaurant')}}/js/wow.min.js"></script>
...
<body>
	...
	<section id="hero-area">
		<img class="img-responsive" src="{{asset('restaurant')}}/images/header.jpg" alt="">
	</section>
	<!--
    Header start
	============================== -->
	...
	<section id="about-us">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="block">
						<img class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms" src="{{asset('restaurant')}}/images/cooker-img.png"
							alt="cooker-img">
					...
					<div class="block">
						...
						<ul>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="300ms">
								<div class="blog-img">
									<img src="{{asset('restaurant')}}/images/blog/blog-img-1.jpg" alt="blog-img">
								</div>
							...
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="400ms">
								<div class="blog-img">
									<img src="{{asset('restaurant')}}/images/blog/blog-img-2.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...
							...
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="500ms">
								...
								<div class="blog-img-2">
									<img src="{{asset('restaurant')}}/images/blog/blog-img-3.jpg" alt="blog-img">
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="600ms">
								...
								<div class="blog-img-2">
									<img src="{{asset('restaurant')}}/images/blog/blog-img-4.jpg" alt="blog-img">
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="700ms">
								<div class="blog-img">
									<img src="{{asset('restaurant')}}/images/blog/blog-img-5.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...
							...
							<li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="800ms">
								<div class="blog-img">
									<img src="{{asset('restaurant')}}/images/blog/blog-img-6.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...
				...
				<div class="col-md-4">
					<div class="block wow fadeInLeft" data-wow-delay="1100ms">
						<div class="gallary">
							...
							<ul>
								<li>
									<a href="#"><img src="{{asset('restaurant')}}/images/photo/photo-1.jpg" alt=""></a>
								</li>
								<li>
									<a href="#"><img src="{{asset('restaurant')}}/images/photo/photo-2.jpg" alt=""></a>
								</li>
								<li>
									<a href="#"><img src="{{asset('restaurant')}}/images/photo/photo-3.jpg" alt=""></a>
								</li>
								<li>
									<a href="#"><img src="{{asset('restaurant')}}/images/photo/photo-4.jpg" alt=""></a>
								</li>
							</ul>
						</div>
